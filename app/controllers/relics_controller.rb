class RelicsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @relic.save
        format.html { redirect_to relic_url(@relic), notice: "Relic was successfully created." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to relics_url, notice: "Relic was successfully destroyed." }
...
# prevent editing of relics by anyone but original owner
  def correct_user
    ...
    redirect_to relics_path, notice: "Not authorised to do that." if @relic.nil?
  end
